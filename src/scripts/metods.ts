...
// let agesToNumber = ages.map((age) => parseInt(age));
...
// let newArray = [...numbers, ...numbersMoreFive] // 1 variant
// let newArray2 = numbers.concat(numbersMoreFive, agesToNumber) // 2 variant
